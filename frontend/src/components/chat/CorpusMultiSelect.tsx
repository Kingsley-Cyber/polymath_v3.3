    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-1 w-64 max-w-[calc(100vw-1rem)] max-h-[calc(100dvh-7rem)] overflow-hidden border border-white/10 bg-[#2a2a2a] z-[60] p-1 shadow-xl rounded">
          ...
          <div className="max-h-[min(15rem,calc(100dvh-11rem))] overflow-y-auto custom-scrollbar flex flex-col gap-0.5">
            {loading ? (
              ...
              corpora.map((corpus) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-4 h-4 border flex-shrink-0 flex items-center justify-center bg-bg-base border-border-minimal"
                    >
          ...
          <div className="px-2 py-1.5 mt-1 border-t border-border-minimal text-[8px] text-content-tertiary uppercase tracking-wider text-center">
            {selectedCount === 0
              ...
              : "Selected corpora scope chat and graph views"}
          </div>
        </div>
      )}
    </div>
