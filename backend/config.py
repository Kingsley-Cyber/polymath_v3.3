...
class Settings(BaseSettings):
    ...
    SEMANTIC_DIGEST_TIER0_ENABLED: bool = Field(
        default=False,
        description=(
            "Dark-launch purchased SemanticDigestV1 summary+central-thesis "
            "routing points in Tier-0. Default OFF; digest points are "
            "explicitly excluded from routing while disabled."
        ),
    )
