...
_DOMAIN_RULES: list[dict[str, Any]] = [
    {
        ...
        "relations": ["part_of", "uses", "calls", "implements", "depends_on", "produces", "stores", "supports", "references"],
    ...
    },
    {
        ...
        "relations": ["uses", "calls", "implements", "depends_on", "produces", "extracts", "trained_on", "supports", "derived_from", "references"],
