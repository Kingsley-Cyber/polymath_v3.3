...
class ChatOrchestrator:
    ...
    async def process_chat_request(
        ...
        # Semantic activation — exact-sentence candidate anchors are attached
        # only after final source selection. They do not participate in
        # retrieval, scoring, answerability counts, or source ordering.
