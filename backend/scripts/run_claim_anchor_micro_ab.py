...
def main() -> int:
    ...
    try:
            ...
            results.append(
                {
                    ...
                    "selected_sources": [
                        _source_without_claim_anchors(source)
                        for source in raw["sources"]
                    ],
                    ...
                    "anchor_trace": trace,
                    "additivity_verified": trace.get("additivity_verified"),
        ...
        for row in results:
            ...
            if expected_enabled and row["additivity_verified"] is not True:
                failures.append(f"{row['query_id']}:additivity_unverified")
