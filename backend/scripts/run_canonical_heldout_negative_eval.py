...
_validate_local_api = validate_local_eval_api
_validate_same_container_runtime = validate_same_container_runtime
...
def _build_execution(
    *,
    ...
    answerability = extract_answerability_contract(raw["traces"])
    ...
    technical_errors.extend(answerability["errors"])
