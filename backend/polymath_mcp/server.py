...
def _build_mcp_server():
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "retrieve evidence chunks across corpora.\n"
            "  • SYNTHESIZE  polymath_chat_query — natural-language question, "
            "grounded answer. Caps at 3 corpora per call; widen with "
            "cross_corpus_search first if you need more.\n"
            "  • ANALYZE     polymath_graph_query, polymath_search_entities, "
